...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parliament-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11753&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parliament-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parliament` can be installed with:

```
conda install parliament
```

It is possible to list all of the versions of `parliament` available on your platform with:
